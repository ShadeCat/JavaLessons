...
Нужно реализовать метод, на вход которого подается массив из целых неотрицательных чисел, на выход - отсортированный массив.*/
...
public class TanosSort {
    ...
    private static int[] toSort(int[] arrayPart){
